...
from razdel import sentenize #для членения текста на предложения сипользуем модуль razdel
from file_utils import read_csv_file, read_text_file
...
между
'''
russian_stopwords = stopwords.split()
