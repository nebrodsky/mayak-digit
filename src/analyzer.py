...
2. "Индекс контекстуальной близости" (Индекс Маяка): частота и плотность нахождения слова рядом с таргетом в стихах. Учитывает "лесенку", границы строк (переход строки снижает вес связи) и границы предложений. Высокий индекс = слова "живут" в одном контексте.
...
Абзац 2: Синонимы в текстах (кто "дружит" с таргетом, а кто игнорируется), сравнение с ближайшими соседями по Индексу Маяка.
...
--- БЛИЖАЙШИЕ СОСЕДИ ПО ИНДЕКСУ МАЯКА (ТОП-10) ---
