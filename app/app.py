...
По своей логике индекс похож на дистрибутивно-семантический подход.
...
Индекс Маяка сканирует **весь текст** каждого стихотворения и суммирует веса по **всем вхождениям** слова в корпусе, а также учиытвает динамику - расстояние между словом и соседними словами, а также структуру текста (переносы строк и границы предложений).
